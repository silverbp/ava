...
const (
	AuthService_ExchangeCode_FullMethodName = "/ava.v1.AuthService/ExchangeCode"
	AuthService_RefreshToken_FullMethodName = "/ava.v1.AuthService/RefreshToken"
	AuthService_Logout_FullMethodName       = "/ava.v1.AuthService/Logout"
)
...
// (internal/server/httpauth.go) to avactl: the browser hands the CLI's
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ava.v1.AuthService",

...
func (s *estimateService) ListEstimates(ctx context.Context, req *avav1.ListEstimatesRequest) (*avav1.ListEstimatesResponse, error) {
	...
	return &avav1.ListEstimatesResponse{Estimates: pbs}, nil
}
...
func (s *estimateService) CreateEstimate(ctx context.Context, req *avav1.CreateEstimateRequest) (*avav1.CreateEstimateResponse, error) {
	...
	return &avav1.CreateEstimateResponse{Estimate: estimateWithLines(estimate, lineItems)}, nil
}
...
func (s *estimateService) UpdateEstimateLineItems(ctx context.Context, req *avav1.UpdateEstimateLineItemsRequest) (*avav1.UpdateEstimateLineItemsResponse, error) {
	...
	return &avav1.UpdateEstimateLineItemsResponse{Estimate: estimateWithLines(estimate, lineItems)}, nil
}
...
// one query.
func estimatesToProto(ctx context.Context, q *sqlcgen.Queries, rows []sqlcgen.Estimate) ([]*avav1.Estimate, error) {
...
// holds.
func estimateWithLines(e sqlcgen.Estimate, lineItems []sqlcgen.EstimateLineItem) *avav1.Estimate {
	pb := &avav1.Estimate{
		Id:              e.ID,
	...
	for _, li := range lineItems {
		...
		pb.LineItems = append(pb.LineItems, &avav1.EstimateLineItem{
			Id:           li.ID,

...
func dec(v string) *avav1.Decimal { return &avav1.Decimal{Value: v} }
	...
	return []crudCase{
		{
			...
			create: func(tc *testTenant) (int64, int64) {
				b := must(businesses.GetBusiness(tc.ctx, &avav1.GetBusinessRequest{Id: tc.businessID}))
				return b.GetBusiness().GetId(), b.GetBusiness().GetResourceVersion()
			},
			get: func(ctx context.Context, id int64) (int64, error) {
				r, err := businesses.GetBusiness(ctx, &avav1.GetBusinessRequest{Id: id})
				return r.GetBusiness().GetResourceVersion(), err
			},
			update: func(ctx context.Context, id, v int64) (int64, error) {
				r, err := businesses.UpdateBusiness(ctx, &avav1.UpdateBusinessRequest{Id: id, ResourceVersion: v, Name: ptr("Renamed")})
				return r.GetBusiness().GetResourceVersion(), err
			},
			deactivate: func(ctx context.Context, id, v int64) error {
				_, err := businesses.DeactivateBusiness(ctx, &avav1.DeactivateBusinessRequest{Id: id, ResourceVersion: v})
				return err
			},
		...
		},
		{
			name: "ledger-account",
			create: func(tc *testTenant) (int64, int64) {
				a := must(accounts.CreateLedgerAccount(tc.ctx, &avav1.CreateLedgerAccountRequest{BusinessId: tc.businessID, AccountTypeId: 1, Code: "1900", Name: "Misc"}))
				return int64(a.GetAccount().GetId()), a.GetAccount().GetResourceVersion()
			},
			get: func(ctx context.Context, id int64) (int64, error) {
				r, err := accounts.GetLedgerAccount(ctx, &avav1.GetLedgerAccountRequest{Id: int32(id)})
				return r.GetAccount().GetResourceVersion(), err
			},
			update: func(ctx context.Context, id, v int64) (int64, error) {
				r, err := accounts.UpdateLedgerAccount(ctx, &avav1.UpdateLedgerAccountRequest{Id: int32(id), ResourceVersion: v, Name: ptr("Renamed")})
				return r.GetAccount().GetResourceVersion(), err
			},
			deactivate: func(ctx context.Context, id, v int64) error {
				_, err := accounts.DeactivateLedgerAccount(ctx, &avav1.DeactivateLedgerAccountRequest{Id: int32(id), ResourceVersion: v})
				return err
			},
			deactivateAgain: codes.Aborted,
		},
		{
			name: "contact",
			create: func(tc *testTenant) (int64, int64) {
				c := must(contacts.CreateContact(tc.ctx, &avav1.CreateContactRequest{BusinessId: tc.businessID, ContactNumber: "C-1", Name: "Acme", IsCustomer: true}))
				return c.GetContact().GetId(), c.GetContact().GetResourceVersion()
			},
			get: func(ctx context.Context, id int64) (int64, error) {
				r, err := contacts.GetContact(ctx, &avav1.GetContactRequest{Id: id})
				return r.GetContact().GetResourceVersion(), err
			},
			update: func(ctx context.Context, id, v int64) (int64, error) {
				r, err := contacts.UpdateContact(ctx, &avav1.UpdateContactRequest{Id: id, ResourceVersion: v, Phone: ptr("555-0100")})
				return r.GetContact().GetResourceVersion(), err
			},
			deactivate: func(ctx context.Context, id, v int64) error {
				_, err := contacts.DeactivateContact(ctx, &avav1.DeactivateContactRequest{Id: id, ResourceVersion: v})
				return err
			},
			deactivateAgain: codes.Aborted,
		},
		{
			...
			create: func(tc *testTenant) (int64, int64) {
				...
				it := must(items.CreateItem(tc.ctx, &avav1.CreateItemRequest{BusinessId: tc.businessID, ItemCode: "SVC", Name: "Service", RetailPrice: dec("10.00"), DefaultLedgerAccountId: &rev}))
				return it.GetItem().GetId(), it.GetItem().GetResourceVersion()
			},
			get: func(ctx context.Context, id int64) (int64, error) {
				r, err := items.GetItem(ctx, &avav1.GetItemRequest{Id: id})
				return r.GetItem().GetResourceVersion(), err
			},
			update: func(ctx context.Context, id, v int64) (int64, error) {
				r, err := items.UpdateItem(ctx, &avav1.UpdateItemRequest{Id: id, ResourceVersion: v, RetailPrice: dec("12.50")})
				return r.GetItem().GetResourceVersion(), err
			},
			deactivate: func(ctx context.Context, id, v int64) error {
				_, err := items.DeactivateItem(ctx, &avav1.DeactivateItemRequest{Id: id, ResourceVersion: v})
				return err
			},
			deactivateAgain: codes.Aborted,
		},
		{
			...
			create: func(tc *testTenant) (int64, int64) {
				...
				tr := must(taxRates.CreateTaxRate(tc.ctx, &avav1.CreateTaxRateRequest{BusinessId: tc.businessID, Name: "Sales Tax", Rate: dec("0.0825"), TaxLiabilityAccountId: liab}))
				return tr.GetTaxRate().GetId(), tr.GetTaxRate().GetResourceVersion()
			},
			get: func(ctx context.Context, id int64) (int64, error) {
				r, err := taxRates.GetTaxRate(ctx, &avav1.GetTaxRateRequest{Id: id})
				return r.GetTaxRate().GetResourceVersion(), err
			},
			update: func(ctx context.Context, id, v int64) (int64, error) {
				r, err := taxRates.UpdateTaxRate(ctx, &avav1.UpdateTaxRateRequest{Id: id, ResourceVersion: v, Rate: dec("0.09")})
				return r.GetTaxRate().GetResourceVersion(), err
			},
			deactivate: func(ctx context.Context, id, v int64) error {
				_, err := taxRates.DeactivateTaxRate(ctx, &avav1.DeactivateTaxRateRequest{Id: id, ResourceVersion: v})
				return err
			},
			deactivateAgain: codes.Aborted,
		},
		{
			...
			create: func(tc *testTenant) (int64, int64) {
				...
				bs := must(statements.CreateBankStatement(tc.ctx, &avav1.CreateBankStatementRequest{BusinessId: tc.businessID, LedgerAccountId: cash, StatementName: "Jan", StatementDate: dateOf(2026, 1, 31), OpeningBalance: dec("0"), ClosingBalance: dec("0")}))
				return bs.GetBankStatement().GetId(), bs.GetBankStatement().GetResourceVersion()
			},
			get: func(ctx context.Context, id int64) (int64, error) {
				r, err := statements.GetBankStatement(ctx, &avav1.GetBankStatementRequest{Id: id})
				return r.GetBankStatement().GetResourceVersion(), err
			},
			update: func(ctx context.Context, id, v int64) (int64, error) {
				r, err := statements.UpdateBankStatement(ctx, &avav1.UpdateBankStatementRequest{Id: id, ResourceVersion: v, StatementName: ptr("January")})
				return r.GetBankStatement().GetResourceVersion(), err
			},
			deactivate: func(ctx context.Context, id, v int64) error {
				_, err := statements.DeactivateBankStatement(ctx, &avav1.DeactivateBankStatementRequest{Id: id, ResourceVersion: v})
				return err
			},
		...
		},
		{
			...
			create: func(tc *testTenant) (int64, int64) {
				...
				e := must(estimates.CreateEstimate(tc.ctx, &avav1.CreateEstimateRequest{
					BusinessId: tc.businessID, CustomerId: cust, EstimateDate: dateOf(2026, 1, 1), ExpirationDate: dateOf(2026, 2, 1),
					LineItems: []*avav1.NewDocumentLineItem{{ItemId: item, LineNumber: 1, Quantity: dec("2")}},
				}))
				return e.GetEstimate().GetId(), e.GetEstimate().GetResourceVersion()
			},
			get: func(ctx context.Context, id int64) (int64, error) {
				r, err := estimates.GetEstimate(ctx, &avav1.GetEstimateRequest{Id: id})
				return r.GetEstimate().GetResourceVersion(), err
			},
			update: func(ctx context.Context, id, v int64) (int64, error) {
				e, err := estimates.GetEstimate(ctx, &avav1.GetEstimateRequest{Id: id})
				if err != nil {
					return 0, err
				}
				item := e.GetEstimate().GetLineItems()[0].GetItemId()
				r, err := estimates.UpdateEstimateLineItems(ctx, &avav1.UpdateEstimateLineItemsRequest{Id: id, ResourceVersion: v,
					LineItems: []*avav1.NewDocumentLineItem{{ItemId: item, LineNumber: 1, Quantity: dec("3")}}})
				return r.GetEstimate().GetResourceVersion(), err
			},
			deactivate: func(ctx context.Context, id, v int64) error {
				_, err := estimates.UpdateEstimateStatus(ctx, &avav1.UpdateEstimateStatusRequest{Id: id, ResourceVersion: v, Status: "SENT"})
				return err
			},
			deactivateAgain: codes.Aborted,
		},
		{
			...
			create: func(tc *testTenant) (int64, int64) {
				cust, item := tc.customerAndItem()
				inv := must(invoices.CreateInvoice(tc.ctx, &avav1.CreateInvoiceRequest{
			...
			get: func(ctx context.Context, id int64) (int64, error) {
				r, err := invoices.GetInvoice(ctx, &avav1.GetInvoiceRequest{Id: id})
				return r.GetInvoice().GetResourceVersion(), err
			},
			update: func(ctx context.Context, id, v int64) (int64, error) {
				r, err := invoices.UpdateInvoice(ctx, &avav1.UpdateInvoiceRequest{Id: id, ResourceVersion: v, Notes: ptr("thanks")})
				return r.GetInvoice().GetResourceVersion(), err
			},
			deactivate: func(ctx context.Context, id, v int64) error {
				_, err := invoices.UpdateInvoiceStatus(ctx, &avav1.UpdateInvoiceStatusRequest{Id: id, ResourceVersion: v, Status: "CANCELLED"})
				return err
			},
...
func (tc *testTenant) account(accountType int32, code, name string) int32 {
	tc.t.Helper()
	r := must(newLedgerAccountService(tc.store).CreateLedgerAccount(tc.ctx, &avav1.CreateLedgerAccountRequest{

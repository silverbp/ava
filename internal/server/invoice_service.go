...
func (s *invoiceService) ListInvoices(ctx context.Context, req *avav1.ListInvoicesRequest) (*avav1.ListInvoicesResponse, error) {
	...
	return &avav1.ListInvoicesResponse{Invoices: pbs}, nil
}
...
func (s *invoiceService) CreateInvoice(ctx context.Context, req *avav1.CreateInvoiceRequest) (*avav1.CreateInvoiceResponse, error) {
	...
	return &avav1.CreateInvoiceResponse{Invoice: invoiceWithLines(invoice, lineItems)}, nil
}
...
func (s *invoiceService) invoiceStatusResponse(ctx context.Context, updated sqlcgen.Invoice) (*avav1.UpdateInvoiceStatusResponse, error) {
	pb, err := invoiceToProto(ctx, s.store.Queries, updated)
	if err != nil {
		return nil, err
	}
...
func (s *invoiceService) UpdateInvoiceLineItems(ctx context.Context, req *avav1.UpdateInvoiceLineItemsRequest) (*avav1.UpdateInvoiceLineItemsResponse, error) {
	...
	return &avav1.UpdateInvoiceLineItemsResponse{Invoice: invoiceWithLines(invoice, lineItems)}, nil
}
...
func invoiceToProto(ctx context.Context, q *sqlcgen.Queries, inv sqlcgen.Invoice) (*avav1.Invoice, error) {
...
// one query.
func invoicesToProto(ctx context.Context, q *sqlcgen.Queries, rows []sqlcgen.Invoice) ([]*avav1.Invoice, error) {
...
func invoiceWithLines(inv sqlcgen.Invoice, lineItems []sqlcgen.InvoiceLineItem) *avav1.Invoice {
	pb := &avav1.Invoice{
		Id:                  inv.ID,
	...
	for _, li := range lineItems {
		...
		pb.LineItems = append(pb.LineItems, &avav1.InvoiceLineItem{
			Id:              li.ID,

...
func TestListLedgerReferenceData(t *testing.T) {
	...
	resp := must(svc.ListLedgerReferenceData(tc.ctx, &avav1.ListLedgerReferenceDataRequest{}))
	...
	outsiderResp, err := svc.ListLedgerReferenceData(tc.outsider, &avav1.ListLedgerReferenceDataRequest{})
	if err != nil {
	...
	_, err = svc.ListLedgerReferenceData(context.Background(), &avav1.ListLedgerReferenceDataRequest{})

...
func buildDocumentLines(ctx context.Context, q *sqlcgen.Queries, businessID int64, raw []*avav1.NewDocumentLineItem, forInvoice bool) ([]documentLine, documentTotals, error) {
...
func resolveLine(lineIdx int, li *avav1.NewDocumentLineItem, item sqlcgen.Item, forInvoice bool) (resolvedLine, error) {
...
func resolveLines(ctx context.Context, q *sqlcgen.Queries, businessID int64, raw []*avav1.NewDocumentLineItem, forInvoice bool) ([]resolvedLine, error) {
...
func newDocumentLineItemsFromEstimate(estLines []sqlcgen.EstimateLineItem) []*avav1.NewDocumentLineItem {
	out := make([]*avav1.NewDocumentLineItem, len(estLines))
	for i, eli := range estLines {
		...
		out[i] = &avav1.NewDocumentLineItem{
			ItemId:      itemID,
...
type lineAmounts struct {
	Quantity, UnitPrice, LineSubtotal, TaxAmount, LineTotal *avav1.Decimal
}

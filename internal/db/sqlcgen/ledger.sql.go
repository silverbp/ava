...
RETURNING id, business_id, account_type_id, code, name, description, parent_account_id, is_system, is_reconcilable, is_container, display_sequence, default_tax_rate_id, cash_flow_category_id, is_active, created_by_user_id, created_at, updated_at
`
...
SELECT id, business_id, account_type_id, code, name, description, parent_account_id, is_system, is_reconcilable, is_container, display_sequence, default_tax_rate_id, cash_flow_category_id, is_active, created_by_user_id, created_at, updated_at FROM ledger_account WHERE id = $1
`
...
SELECT id, business_id, account_type_id, code, name, description, parent_account_id, is_system, is_reconcilable, is_container, display_sequence, default_tax_rate_id, cash_flow_category_id, is_active, created_by_user_id, created_at, updated_at FROM ledger_account WHERE business_id = $1 AND code = $2
`
...
SELECT id, business_id, account_type_id, code, name, description, parent_account_id, is_system, is_reconcilable, is_container, display_sequence, default_tax_rate_id, cash_flow_category_id, is_active, created_by_user_id, created_at, updated_at FROM ledger_account WHERE business_id = $1 ORDER BY code
`
